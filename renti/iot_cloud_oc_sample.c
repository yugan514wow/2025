...
{
    oc_mqtt_profile_service_t object;
    ...
    object.event_time = NULL;
    object.service_id = "object";
    object.service_property = &temperature;
    object.nxt = NULL;
    ...
    oc_mqtt_profile_propertyreport(NULL, &object);
    return;
}
